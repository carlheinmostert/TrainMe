...
class _UnifiedPreviewScreenState extends State<UnifiedPreviewScreen> {
  ...
  //
  // The `share_image` + `share_file` payloads (lobby PNG / multi-page PDF
  // export) were retired 2026-05-26 per ADR 0025 — the free artifact
  // moved off the on-device export pipeline to the live workout-handout
  // web artifact at session.homefit.studio/h/{planId}, and Save-PDF is
  // now a browser-native window.print() against handout.css.
  //
