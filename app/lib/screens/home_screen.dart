      ...
      body: SafeArea(
        child: Stack(
          ...
          children: [
            ...
            // Self-trainer wave intro banner (PR #10). Renders once per
            // device on the first cold launch post-update, then never
            // again. Sits between the brand lockup and the scope row so
            // it reads as a top-of-Home announcement, not a content-list
            // chrome element. The widget self-hides when the
            // SharedPreferences dismiss flag is set, so this slot is
            // visually empty for users who've already seen it.
