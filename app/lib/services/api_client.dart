...
class ApiClient {
  ...
  /// Normalises the two shapes a Supabase RPC can return for a single row:
  ///   * A bare `Map<String, dynamic>` (PostgREST unwraps singleton SETOF).
  ///   * A `List<Map<String, dynamic>>` (the general case).
  /// Returns the first row, or null when the result is empty or null.
