...
///
/// Persisted in SQLite table `cached_clients` (schema v17). Read by Home
/// / ClientSessions / PracticeSwitcher UIs to decouple rendering from
/// the network. Written by [SyncService] on both cloud pulls and local
/// mutations (which queue a [PendingOp] for eventual flush).
///
