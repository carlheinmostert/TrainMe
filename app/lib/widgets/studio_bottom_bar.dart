            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 2026-05-27 — the per-publish credit-cost caption
                  // ("FREE / 1 CR / 2 CR") that used to sit below the
                  // PUBLISH label was removed at Carl's request. The
                  // running cost still surfaces inside the publish gate
                  // sheet's footer total; the toolbar cell now reads as
                  // a plain launcher. `cellActive` stays referenced by
                  // the glyph/label colours above.
                ],
              ),
            ),
          ),
