...
(function () {
  ...
  // $lobbyShareBtn removed 2026-05-26 per ADR 0025 — the share path
  // moved off the lobby to the new workout-handout artifact (/h/{planId}).
  ...
  function exerciseRowHTML(slide, slideIndex, _opts) {
    ...
    // the row mounts — see hydrateHeroCrops below.
  ...
  function wireEvents() {
    ...
    // Lobby-share click handler removed 2026-05-26 per ADR 0025 — the
    // PDF export pipeline (triggerLobbyShare + html2canvas + jsPDF) is
    // superseded by the workout-handout artifact at /h/{planId} +
